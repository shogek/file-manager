...
app.on("ready", () => {
  ipcMain.handle("app-create-folder", (_, args: IpcCreateFolderArgs) =>
    ipcService.createFolder(args)
  );

  ipcMain.handle(
    "app-read-working-folder",
    (_, args: IpcReadWorkingFolderArgs) => ipcService.readWorkingFolder(args)
  );
